...
SPCA=function(X,d)
{
  ...
  o <- list(c,V,r,SS,SS_new,part,mu,c.d)
  names(o) <- c("c", "V", "r", "SS", "SS_new", "partition",
                "mu", "c_d")
  return(o)
}
...
{ 
  ...
  o <- list(SS,SS_new,Y.hatD,Y.hatd,Y.hatD.pc,Y.hatd.pc)
  names(o) <- c("SS", "SS_new", "Y_D", "Y_d", "Y_D_pc", "Y_d_pc")
  return(o)
} 
