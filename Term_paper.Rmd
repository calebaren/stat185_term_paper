...
A simple alternative that is able to handle curvature as well as out-of-sample error is to use pieces of spheres or *spherelets* to locally approximate the unknown subspace [@li2019].
...
An Euler spiral is a special geometric figure in $\mathbb{R}^1$ that has a curvature that changes linearly with arc length. An Euler spiral can be parametrized as follows:
